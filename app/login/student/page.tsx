...
function StudentLoginContent() {
  ...
  return (
    <div className="bg-[#050811] text-slate-200 min-h-screen relative overflow-hidden flex flex-col justify-center items-center p-4 sm:p-6">
      ...
      <Link 
        href="/" 
        className="absolute top-6 start-6 z-30 flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-[#090f1c]/80 hover:bg-[#111a2e] border border-slate-800 hover:border-emerald-500/40 text-slate-300 hover:text-emerald-400 text-xs font-bold transition-all duration-300 backdrop-blur-xl shadow-lg select-none group"
      >
      ...
      <div className="absolute w-[450px] h-[450px] rounded-full blur-[140px] top-[-10%] end-[-5%] bg-emerald-500/[0.04]" />
      ...
      >
        ...
        <form onSubmit={handleLoginSubmit} className="space-y-5">
          <div>
            <label className="block text-xs font-semibold text-slate-400 mb-2 px-1">{t('studentIdLabel')}</label>
            <div className="relative flex items-center">
              ...
              <input 
                ...
                className="w-full bg-[#04070d]/90 border border-slate-800/80 rounded-2xl ps-11 pe-4 py-3.5 text-sm text-slate-100 placeholder-slate-600 focus:outline-none transition-all duration-300 focus:ring-4 focus:border-emerald-500/60 focus:ring-emerald-500/10" 
          ...
          <div>
            ...
            <div className="relative flex items-center">
              ...
              <input 
                ...
                className="w-full bg-[#04070d]/90 border border-slate-800/80 rounded-2xl ps-11 pe-12 py-3.5 text-sm text-slate-100 placeholder-slate-600 focus:outline-none transition-all duration-300 focus:ring-4 focus:border-emerald-500/60 focus:ring-emerald-500/10" 
              ...
              <button 
                ...
                className="absolute end-4 text-slate-500 hover:text-emerald-400 transition-colors p-1 select-none"
          ...
          <button 
            type="submit" 
            disabled={isLoading} 
            className="w-full text-white font-bold py-4 px-4 rounded-2xl text-sm transition-all duration-300 active:scale-[0.98] mt-4 shadow-xl bg-gradient-to-r from-emerald-600 via-emerald-500 to-teal-600 hover:shadow-[0_0_25px_rgba(16,185,129,0.3)] flex items-center justify-center gap-2.5 group select-none"
          >
            {isLoading ? (
              <span>{t('checkingFirewall')}</span>
            ) : (
              <>
        ...
        <div className="mt-6 text-center text-xs border-t border-slate-900 pt-5 select-none">
          ...
          <Link href="/login/register" className="text-emerald-400 font-extrabold hover:underline">
            {t('createAccount')}
          </Link>
        </div>
